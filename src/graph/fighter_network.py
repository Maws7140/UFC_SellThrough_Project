...
try:
    ...
    print("Warning: GraphFrames not installed. Install with: pip install graphframes")
...
def compute_pagerank(graph, reset_prob=0.15, max_iter=20):
    # PageRank measures importance - fighters who fight important fighters are more important
...
def create_placeholder_features(spark, fights_df, output_dir):
    # Simple fallback when GraphFrames isn't available - just count fights
    ...
    # Can't compute these without GraphFrames, so set to 0
